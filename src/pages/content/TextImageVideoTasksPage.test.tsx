...
describe("TextImageVideoTasksPage", () => {
  ...
  it("navigates to the create page from the task list create button", () => {
    renderTaskListPage();

    fireEvent.click(screen.getByRole("button", { name: "新增视频" }));

    expect(listPageMocks.navigate).toHaveBeenCalledWith("/image-video");
  });
