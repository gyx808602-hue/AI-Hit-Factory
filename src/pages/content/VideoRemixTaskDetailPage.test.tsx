...
describe("VideoRemixTaskDetailPage", () => {
  ...
  it("removes product and character image previews and blocks save when required product image is empty", async () => {
    renderDetailPage();
    ...
    expect(await screen.findByTestId("video-remix-product-image-error")).toBeInTheDocument();
  });
