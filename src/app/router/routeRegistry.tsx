...
export const routeRegistry: AppRoute[] = [
  ...
  },
  {
    ...
    meta: { title: "追爆任务", icon: "ListTodo", cache: true, requiresAuth: true },
  },
  {
  ...
  },
  {
    ...
    meta: { title: "文图生成视频", icon: "Image", cache: false, requiresAuth: true },
  },
  {
    key: "content.imageVideoTasks",
    path: "/image-video/tasks",
    component: TextImageVideoTasksPage,
    meta: { title: "文图生视频任务", icon: "ListTodo", cache: true, requiresAuth: true },
  },
  {
  ...
  },
  {
    ...
    meta: { title: "数字人视频任务", icon: "ListTodo", cache: true, requiresAuth: true },
  },
  {
